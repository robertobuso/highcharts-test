...
let processedData = []
  ...
  export const createOptions = (parameters) => {
    console.log('WERE IN CREATEOPTIONS!')
    console.log('processedData: ', processedData)
    console.log('formParameters: ', parameters)
  ...
  //Set initial ceiling and floor based on direction of first bar
    ...
    processedData = newArray.map( bar => {
    // data to moment object
    const stringDateTime = moment.utc(bar[0] + " " + bar[1])
    //moment object to local time zone
    const localDate = moment(stringDateTime).local()
  ...
  console.log('The ID is: ', idx)
    ...
    export const baseMarkers = actualBases.map( base => {
      ...
      export const notFresh = notFreshZones

      export const badIncomingLeg = invalidIncomingLegZones

      export const badLegBases = invalidLegBaseZones
  ...
  export const cylinderData = [{ name: 'T3',
    ...
    export const finalData = processedData
